...
co2_data = pd.read_csv("clean_datasets/updated_transformed_owid_co2_data.csv")
...
tree_cover_filtered.to_csv("filtered_datasets/filtered_tree_cover.csv", index=False)
co2_filtered.to_csv("filtered_datasets/filtered_co2_data.csv", index=False)
weather_filtered.to_csv("filtered_datasets/filtered_weather_data.csv", index=False)
